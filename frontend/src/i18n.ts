    ...
    translation: {
      common: {
        ...
        installPrompt: {
          ...
          description: "Добавьте CholestoFit на главный экран, чтобы всегда иметь быстрый доступ.",
          install: "Установить",
          later: "Позже",
        },
  ...
  en: {
    translation: {
      common: {
        ...
        installPrompt: {
          title: "Install CholestoFit",
          description: "Add CholestoFit to your home screen for instant access.",
          install: "Install",
          later: "Later",
        },
    ...
    translation: {
      common: {
        ...
        installPrompt: {
          ...
          description: "Fügen Sie CholestoFit Ihrem Startbildschirm für schnellen Zugriff hinzu.",
    ...
    translation: {
      common: {
        ...
        installPrompt: {
          ...
          description: "Añade CholestoFit a tu pantalla de inicio para acceder al instante.",
          install: "Instalar",
          later: "Más tarde",
        },
