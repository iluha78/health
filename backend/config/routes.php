...
$app->post('/advice/nutrition/photo',         [AdviceController::class, 'nutritionPhoto'])->add(new JwtMiddleware());
$app->post('/advice/nutrition/photo/analyze', [AdviceController::class, 'nutritionPhoto'])->add(new JwtMiddleware());
